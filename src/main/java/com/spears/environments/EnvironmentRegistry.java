...
public class EnvironmentRegistry {
    ...
    private static void fillMaps(Reflections reflect){
        ...
        Set<Class<?>> labelmaps = reflect.getTypesAnnotatedWith(com.spears.environments.annotations.Map.class);
        ...
        for (Class<? extends EnvironmentMap> map : realmaps){
            String type = map.getAnnotation(com.spears.environments.annotations.Map.class).type();
    ...
    private static void fillModifiers(Reflections reflect){
        ...
        Set<Class<?>> labelmods = reflect.getTypesAnnotatedWith(Modifier.class);
        ...
        for (Class<? extends EnvironmentModifier> mod : realmods){
            Modifier annotation = mod.getAnnotation(Modifier.class);
     ...
     * @return {@link java.lang.Class} extends {@link PlatformEnvironment PlatformEnvironment}
     */
    @SuppressWarnings("unchecked")
     ...
     * @return {@link java.lang.Class} extends {@link EnvironmentMap EnvironmentMap}
     */
    @SuppressWarnings("unchecked")
     ...
     * @return {@link java.lang.Class} extends {@link EnvironmentModifier EnvironmentModifier}
     */
    @SuppressWarnings("unchecked")
     ...
     * @return {@link java.lang.Class} extends {@link EnvironmentPopulator EnvironmentPopulator}
     */
    @SuppressWarnings("unchecked")
     ...
     * {@link EnvironmentModifier#modify(EnvironmentMap, Map) modify(map, params)}
     ...
     * {@link EnvironmentPopulator#build(EnvironmentMap, Map)}  build(map, params)}
     * is called.  If either the platform type name or the model name are unknown returns null.
     *
     * @param type The type name
     * @param name The name of the populator
