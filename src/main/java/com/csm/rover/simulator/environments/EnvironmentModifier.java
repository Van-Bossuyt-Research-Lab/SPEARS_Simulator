 ...
 * {@link com.csm.rover.simulator.environments.annotations.Modifier modifier} for use.  A generator should produce a
 * unique map, a modifier should manipulate the provided map.
 *
 * @param <T> Map type that extends {@link com.csm.rover.simulator.environments.EnvironmentMap EnvironmentMap}
 */
