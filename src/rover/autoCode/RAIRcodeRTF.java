//This code was last updated on 10/4/2015 to include adjustable RTF on line 117
//Objective function on line 470
...
//Method for determining Point Optimization Score
	private double RouteChoice(DecimalPoint pnt,DecimalPoint loc){
		...
		//Include Risk Tolerance Factor
		score=Math.abs((theta-thetaP)/((theta+thetaP)/2))+riskTolerance*Math.abs((delta_L-Pd_L-1)/((delta_L-Pd_L+3)/2))+hzrds+slopehzrd+intslopehzrd;
		return score;
	}
