...
import com.spears.test.objects.AutoModels.*;
import com.spears.test.objects.PhysicsModels.*;
import com.spears.test.objects.platforms.*;
import com.spears.test.objects.states.*;
...
//  PLATFORMS ----------------------------------------------------------------------------------------------------------
    private void setupFillPlatforms() throws InvocationTargetException, IllegalAccessException {
        ...
        when(reflectionsMock.getTypesAnnotatedWith(com.spears.platforms.annotations.Platform.class)).thenReturn(
