...
public class Globals {
	...
	public void reportError(String obj, String method, Exception error){
	...
	public synchronized void writeToLogFile(String from, String write){ // writes the message to the log generated by the interface
		try {
            InterfaceAccess.CODE.writeToLog(from, write);
        }
		...
		new FreeThread(1000, new Runnable(){
			public void run(){
				...
				if (timeMillis >= exitTime){
					...
					writeToLogFile("Globals", "Forcing Exit");
					System.err.println("Ignore this one:");
					int a = 1/0;
				}
			}
	...
	public String delayThread(String name, int time){
		try {
			...
			try{
				...
				reportError("Globals", "delayThread", ex);
			}
			return "pass";
		}
	} 
