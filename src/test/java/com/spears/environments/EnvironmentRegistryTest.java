...
import com.spears.test.objects.environments.MislabeledEnv;
import com.spears.test.objects.environments.ProtectedSkyEnv;
import com.spears.test.objects.environments.UnlabeledSeaEnv;
import com.spears.test.objects.populators.*;
import com.spears.ui.visual.PopulatorDisplayFunction;
import com.google.common.collect.Sets;
import com.spears.test.objects.maps.*;
import com.spears.test.objects.modifiers.*;
...
public class EnvironmentRegistryTest {
    ...
    private void setupFill(){
        ...
        doReturn(Sets.newHashSet(LandMap.class)).when(reflectionsMock).getTypesAnnotatedWith(com.spears.environments.annotations.Map.class);
...
//  MAPS ---------------------------------------------------------------------------------------------------------------
    private void setupFillMaps() throws InvocationTargetException, IllegalAccessException {
        ...
        doReturn(Sets.newHashSet(LandMap.class, MislabeledMap.class, ProtectedSeaMap.class, UnknownCaveMap.class))
                .when(reflectionsMock).getTypesAnnotatedWith(com.spears.environments.annotations.Map.class);
