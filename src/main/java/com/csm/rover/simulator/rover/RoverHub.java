			...
			if (inHUDmode){
				if (HUDDisplayLinks[x] == -1){
					...
					MovementStatsLbl[x].setText("X: " + formatDouble(rovers[HUDDisplayLinks[x]].getLocation().getX()) 
							+ " m\tAngular Spin FL: " + formatDouble(Math.toDegrees(rovers[HUDDisplayLinks[x]].getWheelSpeed(RoverWheels.FL))) 
							+ " deg/s\nY: " + formatDouble(rovers[HUDDisplayLinks[x]].getLocation().getY()) 
							+ " m\tAngluar Spin FR: " + formatDouble(Math.toDegrees(rovers[HUDDisplayLinks[x]].getWheelSpeed(RoverWheels.FR))) 
							+ " deg/s\nAngle: " + formatDouble(Math.toDegrees(rovers[HUDDisplayLinks[x]].getDirection())) 
							+ " deg\tAngular Spin BL: " + formatDouble(Math.toDegrees(rovers[HUDDisplayLinks[x]].getWheelSpeed(RoverWheels.BL))) 
							+ " deg/s\n\tAngular Spin BR: " + formatDouble(Math.toDegrees(rovers[HUDDisplayLinks[x]].getWheelSpeed(RoverWheels.BR))) 
					...
					ElectricalStatsLbl[x].setText("SOC: " + formatDouble(rovers[HUDDisplayLinks[x]].getSOC())
							...
							+ " A\n\nMotor Current FL: " + formatDouble(Math.abs(rovers[HUDDisplayLinks[x]].getMotorCurrent(RoverWheels.FL))) 
							+ " A\nMotor Current FR: " + formatDouble(Math.abs(rovers[HUDDisplayLinks[x]].getMotorCurrent(RoverWheels.FR))) 
							+ " A\nMotor Current BL: " + formatDouble(Math.abs(rovers[HUDDisplayLinks[x]].getMotorCurrent(RoverWheels.BL))) 
							+ " A\nMotor Current BR: " + formatDouble(Math.abs(rovers[HUDDisplayLinks[x]].getMotorCurrent(RoverWheels.BR)))
							+ " A\n\nMotor Voltage FL: " + formatDouble(rovers[HUDDisplayLinks[x]].getMotorVoltage(RoverWheels.FL))
							+ " V\nMotor Voltage FR: " + formatDouble(rovers[HUDDisplayLinks[x]].getMotorVoltage(RoverWheels.FR))
							+ " V\nMotor Voltage BL: " + formatDouble(rovers[HUDDisplayLinks[x]].getMotorVoltage(RoverWheels.BL))
							+ " V\nMotor Voltage BR: " + formatDouble(rovers[HUDDisplayLinks[x]].getMotorVoltage(RoverWheels.BR)) + " V");
					TemperatureStatsLbl[x].setText("Motor Temperature FL: " + formatDouble(rovers[HUDDisplayLinks[x]].getMotorTemp(RoverWheels.FL)) + " *c\n" +
							"Motor Temperature FR: " + formatDouble(rovers[HUDDisplayLinks[x]].getMotorTemp(RoverWheels.FR)) +" *c\n" +
							"Motor Temperature BL: " + formatDouble(rovers[HUDDisplayLinks[x]].getMotorTemp(RoverWheels.BL)) + " *c\n" +
							"Motor Temperature BR: " + formatDouble(rovers[HUDDisplayLinks[x]].getMotorTemp(RoverWheels.BR)) + " *c\n\n" +
				...
				if (standardDisplayLinks[currentPage][x] == -1){
					...
					MovementStatsLbl[x].setText("X: " + formatDouble(rovers[standardDisplayLinks[currentPage][x]].getLocation().getX()) 
							+ " m\tAngular Spin FL: " + formatDouble(Math.toDegrees(rovers[standardDisplayLinks[currentPage][x]].getWheelSpeed(RoverWheels.FL))) 
							+ " deg/s\nY: " + formatDouble(rovers[standardDisplayLinks[currentPage][x]].getLocation().getY()) 
							+ " m\tAngluar Spin FR: " + formatDouble(Math.toDegrees(rovers[standardDisplayLinks[currentPage][x]].getWheelSpeed(RoverWheels.FR))) 
							+ " deg/s\nAngle: " + formatDouble(Math.toDegrees(rovers[standardDisplayLinks[currentPage][x]].getDirection())) 
							+ " deg\tAngular Spin BL: " + formatDouble(Math.toDegrees(rovers[standardDisplayLinks[currentPage][x]].getWheelSpeed(RoverWheels.BL))) 
							+ " deg/s\n\tAngular Spin BR: " + formatDouble(Math.toDegrees(rovers[standardDisplayLinks[currentPage][x]].getWheelSpeed(RoverWheels.BR))) 
					...
					ElectricalStatsLbl[x].setText("SOC: " + formatDouble(rovers[standardDisplayLinks[currentPage][x]].getSOC())
							...
							+ " A\n\nMotor Current FL: " + formatDouble(Math.abs(rovers[standardDisplayLinks[currentPage][x]].getMotorCurrent(RoverWheels.FL))) 
							+ " A\nMotor Current FR: " + formatDouble(Math.abs(rovers[standardDisplayLinks[currentPage][x]].getMotorCurrent(RoverWheels.FR))) 
							+ " A\nMotor Current BL: " + formatDouble(Math.abs(rovers[standardDisplayLinks[currentPage][x]].getMotorCurrent(RoverWheels.BL))) 
							+ " A\nMotor Current BR: " + formatDouble(Math.abs(rovers[standardDisplayLinks[currentPage][x]].getMotorCurrent(RoverWheels.BR)))
							+ " A\n\nMotor Voltage FL: " + formatDouble(rovers[standardDisplayLinks[currentPage][x]].getMotorVoltage(RoverWheels.FL))
							+ " V\nMotor Voltage FR: " + formatDouble(rovers[standardDisplayLinks[currentPage][x]].getMotorVoltage(RoverWheels.FR))
							+ " V\nMotor Voltage BL: " + formatDouble(rovers[standardDisplayLinks[currentPage][x]].getMotorVoltage(RoverWheels.BL))
							+ " V\nMotor Voltage BR: " + formatDouble(rovers[standardDisplayLinks[currentPage][x]].getMotorVoltage(RoverWheels.BR)) + " V");
					TemperatureStatsLbl[x].setText("Motor Temperature FL: " + formatDouble(rovers[standardDisplayLinks[currentPage][x]].getMotorTemp(RoverWheels.FL)) + " *c\n" +
							"Motor Temperature FR: " + formatDouble(rovers[standardDisplayLinks[currentPage][x]].getMotorTemp(RoverWheels.FR)) +" *c\n" +
							"Motor Temperature BL: " + formatDouble(rovers[standardDisplayLinks[currentPage][x]].getMotorTemp(RoverWheels.BL)) + " *c\n" +
							"Motor Temperature BR: " + formatDouble(rovers[standardDisplayLinks[currentPage][x]].getMotorTemp(RoverWheels.BR)) + " *c\n\n" +
