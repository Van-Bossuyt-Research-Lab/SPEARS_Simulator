...
public class SubDisplayWindow extends JPanel {
    ...
    private JLabel SubNameLbl = new JLabel();
    ...
    private void initialize() {
        ...
        SubNameLbl = new JLabel("Undefined");
        SubNameLbl.setFont(new Font("Trebuchet MS", Font.BOLD, 17));
        SubNameLbl.setHorizontalAlignment(JLabel.CENTER);
        rack.add(SubNameLbl, BorderLayout.CENTER);
    ...
    public void update(int whichSub) {
        if (subLock != -1) {
            whichSub = subLock;
        }
    ...
    public void lockOnSub(int which){
        subLock = which;
        update(which);
    }
